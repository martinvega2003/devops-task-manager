    ...
    <button
      ...
      className={`
        ...
        ${isCloseButton || isDeleteButton ? 
          ...
          isTransparent ? "bg-transparent text-primary dark:text-secondary border-none hover:scale-110" :
          "bg-primary dark:bg-secondary border-primary dark:border-secondary hover:text-primary dark:hover:text-secondary text-white"} 
          text-body py-2 px-4 rounded-md hover:bg-transparent transition duration-300 border-2 cursor-pointer ` + className}
    >
